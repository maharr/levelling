...
public class TraverseTable {
	...
	private static final String TRAVERSE_TABLE_CREATE = "CREATE TABLE "
			+ TRAVERSE_TABLE_NAME + " (" + "_id"
			+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + "name"
			+ " TEXT NOT NULL, " + "type" + " TEXT NOT NULL, " + "observer"
			+ " TEXT, " + "staffman" + " TEXT, " + "survey_date"
	...
	private static final String READING_TABLE_CREATE = "CREATE TABLE "
			+ READING_TABLE_NAME + " (" + "_id"
			+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + "traverse"
			+ " LONG NOT NULL, " + "observation" + " INTEGER NOT NULL, "
			+ "type" + " INTEGER NOT NULL, " + "reading" + " DOUBLE NOT NULL, "
			+ "label" + " TEXT NOT NULL, " + "modified_date"
			+ " TEXT NOT NULL );";
	...
	public static void onUpgrade(SQLiteDatabase database, int oldVersion,
			int newVersion) {
		Log.w(TraverseTable.class.getName(), "Upgrading database from version "
