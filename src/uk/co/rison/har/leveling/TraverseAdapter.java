...
public class TraverseAdapter {
	// Database fields
		...
		public long createTodo(String name, String type, String observer, String staffman, Integer survey_date, Integer modified_date) {
		...
		public boolean updateTodo(long rowId, String name, String type, String observer, String staffman, Integer survey_date, Integer modified_date) {
			ContentValues values = createContentValues(name, type, observer, staffman, survey_date, modified_date);
		...
		private ContentValues createContentValues(String name, String type,	String observer, String staffman, Integer survey_date, Integer modified_date) {
