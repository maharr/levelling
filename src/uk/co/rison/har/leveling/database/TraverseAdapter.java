...
public class TraverseAdapter {
	// Database fields
		...
		public long createTraverse(String name, String type, String observer, String staffman, String survey_date, String modified_date) {
		...
		public boolean updateTraverse(long rowId, String name, String type, String observer, String staffman, String survey_date, String modified_date) {
			ContentValues values = createContentValues(name, type, observer, staffman, survey_date, modified_date);
